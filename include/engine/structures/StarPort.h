...
#ifndef ENGINE_STARPORT_H
#define ENGINE_STARPORT_H
...
public:
    ...
    */
    void doProduceItem(const GameContext& context, ItemID_enum itemID, bool multipleMode = false) override;
    ...
    */
    void doPlaceOrder(const Game& game);
    ...
    */
    ...
    void updateBuildList(const Game& game) override;
