...
public:
    ...
    */
    GameInitSettings(HOUSETYPE newHouseID, const GameOptionsClass& gameOptions);
    ...
    */
    ...
    /**
        ...
        \param  gameOptions         the options for this game
    */
    GameInitSettings(HOUSETYPE newHouseID, int newMission, const GameOptionsClass& gameOptions);
