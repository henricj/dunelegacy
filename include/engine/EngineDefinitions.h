...
#ifndef UTILITYDEFINITIONS_H
#define UTILITYDEFINITIONS_H
...
inline constexpr FixPoint BADLYDAMAGEDRATIO = 0.5_fix; // if health/getMaxHealth() < this, damage will become bad - smoke and shit
inline constexpr FixPoint HEAVILYDAMAGEDRATIO = 0.25_fix; // if health/getMaxHealth() < this, damage will become heavy damage - red color
