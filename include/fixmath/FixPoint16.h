...
public:
    ...
    explicit FixPoint16(const std::string& inValue) { value = fix16_from_str(inValue.c_str()); }
    ...
    FixPoint16& operator>>=(const int rhs) {
        value >>= rhs;
        return *this;
    }
    FixPoint16& operator<<=(const int rhs) {
    ...
    FixPoint16& operator=(const FixPoint16 rhs) {
        value = rhs.value;
        return *this;
    }
    FixPoint16& operator=(const int rhs) {
        value = fix16_from_int(rhs);
        return *this;
    }
    ...
    FixPoint16& operator%=(const FixPoint16 rhs) {
        value = fix16_mod(value, rhs.value);
        return *this;
    }
    FixPoint16& operator%=(const int rhs) {
        value %= rhs;
    ...
    const FixPoint16 operator-() const {
        FixPoint16 ret = *this;
        ret.value      = -ret.value;
        return ret;
    }

    const FixPoint16 operator>>(const int other) const {
        FixPoint16 ret = *this;
        ret >>= other;
        return ret;
    }
    ...
    const FixPoint16 operator+(const FixPoint16 other) const {
        FixPoint16 ret = *this;
        ret += other;
        return ret;
    }
...
static inline const FixPoint16 operator+(int value, const FixPoint16 other) {
    return other + value;
}
static inline const FixPoint16 operator+(unsigned int value, const FixPoint16 other) {
    return other + value;
}
static inline const FixPoint16 operator-(int value, const FixPoint16 other) {
    return FixPoint16(value) - other;
}
static inline const FixPoint16 operator-(unsigned int value, const FixPoint16 other) {
    return FixPoint16(value) - other;
}
...
static inline bool operator==(int value, const FixPoint16 other) {
    return other.operator==(value);
}
static inline bool operator==(unsigned int value, const FixPoint16 other) {
    return other.operator==(value);
}
static inline bool operator!=(int value, const FixPoint16 other) {
    return other.operator!=(value);
...
static inline int lround(FixPoint16 value) {
    return value.lround();
}
static inline int floor(FixPoint32 value) {
    return value.floor();
}
static inline int ceil(FixPoint32 value) {
    return value.ceil();
}
