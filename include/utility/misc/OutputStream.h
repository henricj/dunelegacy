...
public:
    ...
    */
    void writeBools(bool val1 = false, bool val2 = false, bool val3 = false, bool val4 = false, bool val5 = false, bool val6 = false, bool val7 = false, bool val8 = false) {
        uint8_t val = static_cast<uint8_t>(val1) | (val2 << 1) | (val3 << 2) | (val4 << 3) | (val5 << 4) | (val6 << 5) | (val7 << 6) | (val8 << 7);
        writeUint8(val);
    }

    /**
        Writes out a complete vector of uint8_t
    ...
    */
    ...
    /**
        Writes out a complete list of uint32_t
    ...
    */
    ...
    /**
        Writes out a complete vector of uint32_t
        \param  dataVector the vector to write
    */
    ...
    */
    ...
    /**
        Writes out a complete set of uint32_t
        \param  dataSet   the set to write
    */
    template<typename SetType>
    void writeUint32Set(const SetType& dataSet) {
