...
#ifndef DUNE_LEGACY_SDLPP_H
#define DUNE_LEGACY_SDLPP_H

/**
 * @file dune_sdlpp.h
 * @brief C++ wrappers and smart pointers for SDL types.
 *
 * This header provides:
 * - RAII smart pointers for SDL resources (surfaces, textures, windows, etc.)
 * - Lock guard classes for surfaces and textures
 * - Logging utilities using SDL's logging system
 */
...
// =============================================================================
// SDL Smart Pointer Types
// =============================================================================

/// Smart pointer for SDL_malloc'd memory
template<typename T>
