...
void Devastator::blitToScreen() {
    ...
    const auto dest2   = calcSpriteDrawingRectF(
        pTurretGraphic,
        screenborder->world2screenX(realX_ + devastatorTurretOffset[static_cast<int>(drawnAngle_)].x),
        screenborder->world2screenY(realY_ + devastatorTurretOffset[static_cast<int>(drawnAngle_)].y),
        numImagesX_,
        1,
        HAlign::Center,
        VAlign::Center);
