...
constexpr auto GROUNDUNIT_ROW(int i) {
    return std::to_array<int>({(i + 2) | TILE_NORMAL,
                               (i + 1) | TILE_NORMAL,
                               i | TILE_NORMAL,
                               (i + 1) | TILE_FLIPV,
                               (i + 2) | TILE_FLIPV,
...
constexpr auto ORNITHOPTER_ROW(int i) {
    return std::to_array<int>({(i + 6) | TILE_NORMAL,
                               (i + 3) | TILE_NORMAL,
                               i | TILE_NORMAL,
                               (i + 3) | TILE_FLIPV,
                               (i + 6) | TILE_FLIPV,
...
constexpr auto ROCKET_ROW(int i) {
    return std::to_array<int>({(i + 4) | TILE_NORMAL,
                               (i + 3) | TILE_NORMAL,
                               (i + 2) | TILE_NORMAL,
                               (i + 1) | TILE_NORMAL,
                               i | TILE_NORMAL,
...
SurfaceLoader::SurfaceLoader(int width, int height) {
    ...
    if (file_manager->exists(fmt::format("CHOAM.{}", _("LanguageFileExtension")))) {
        ...
        THROW(std::runtime_error,
              "SurfaceLoader::SurfaceLoader(): Cannot open CHOAMSHP.SHP or CHOAM.{}!",
    ...
    { // Scope
        ...
        SDL_SetPaletteColors(
            SDL_GetSurfacePalette(objPic[ObjPic_Harvester][harkIdx][0].get()), &shadowTransparent, PALCOLOR_SHADOW, 1);
        SDL_SetSurfaceBlendMode(objPic[ObjPic_Harvester][harkIdx][0].get(), SDL_BLENDMODE_BLEND);
    }
    ...
    { // Scope
        static constexpr SDL_Color shadowTransparent{0, 0, 0, 96};
        SDL_SetPaletteColors(
            SDL_GetSurfacePalette(objPic[ObjPic_MCV][harkIdx][0].get()), &shadowTransparent, PALCOLOR_SHADOW, 1);
        SDL_SetSurfaceBlendMode(objPic[ObjPic_MCV][harkIdx][0].get(), SDL_BLENDMODE_BLEND);
    }
    ...
    objPic[ObjPic_Troopers][harkIdx][0] = units->getPictureArray(
        4, 4, MULTIINFANTRY_ROW(103), MULTIINFANTRY_ROW(104), MULTIINFANTRY_ROW(105), MULTIINFANTRY_ROW(106));
    objPic[ObjPic_Soldier][harkIdx][0] =
        units->getPictureArray(4, 3, INFANTRY_ROW(73), INFANTRY_ROW(74), INFANTRY_ROW(75));
    objPic[ObjPic_Infantry][harkIdx][0] = units->getPictureArray(
        4, 4, MULTIINFANTRY_ROW(91), MULTIINFANTRY_ROW(92), MULTIINFANTRY_ROW(93), MULTIINFANTRY_ROW(94));
    objPic[ObjPic_Saboteur][harkIdx][0] =
        units->getPictureArray(4, 3, INFANTRY_ROW(63), INFANTRY_ROW(64), INFANTRY_ROW(65));
    objPic[ObjPic_Sandworm][harkIdx][0]            = units1->getPictureArray(1,
                                                                  9,
                                                                  71 | TILE_NORMAL,
                                                                  70 | TILE_NORMAL,
                                                                  69 | TILE_NORMAL,
    ...
    objPic[ObjPic_ExplosionFlames][harkIdx][0]    = units1->getPictureArray(21,
                                                                         1,
                                                                         11 | TILE_NORMAL,
                                                                         12 | TILE_NORMAL,
                                                                         13 | TILE_NORMAL,
    ...
    SDL_SetPaletteColors(
        SDL_GetSurfacePalette(objPic[ObjPic_Terrain_HiddenFog][harkIdx][0].get()), &fogTransparent, PALCOLOR_BLACK, 1);
    ...
    uiGraphic[UI_CreditsDigits][harkIdx] = shapes->getPictureArray(10,
                                                                   1,
                                                                   2 | TILE_NORMAL,
                                                                   3 | TILE_NORMAL,
                                                                   4 | TILE_NORMAL,
    ...
    SDL_SetPaletteColors(
        SDL_GetSurfacePalette(uiGraphic[UI_Indicator][harkIdx].get()), &indicatorTransparent, PALCOLOR_WHITE, 1);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_MapChoiceArrow_LeftUp][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_MapChoiceArrow_RightUp][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_MapChoiceArrow_Right][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_MapChoiceArrow_RightDown][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_MapChoiceArrow_LeftDown][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_StructureSizeLattice][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_StructureSizeConcrete][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_MapEditor_PlayerIcon][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_MapEditor_MapSettingsIcon][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    uiGraphic[UI_MapEditor_ReinforcementsIcon][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)] = scaleSurface(
        ...
        0.66667);
    SDL_SetColorKey(
        uiGraphic[UI_MapEditor_ReinforcementsIcon][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_MapEditor_MirrorNoneIcon][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_MapEditor_MirrorHorizontalIcon][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_MapEditor_MirrorVerticalIcon][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_MapEditor_MirrorBothIcon][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_MapEditor_MirrorPointIcon][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_MapEditor_RotateLeftIcon][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    ...
    SDL_SetColorKey(
        uiGraphic[UI_MapEditor_RotateRightIcon][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(), SDL_TRUE, 0);
    uiGraphic[UI_MapEditor_RotateRightHighlightIcon][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)] =
        mapSurfaceColorRange(
            ...
            PALCOLOR_HARKONNEN - 3);
    SDL_SetColorKey(
        uiGraphic[UI_MapEditor_RotateRightHighlightIcon][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)].get(),
        SDL_TRUE,
        0);
    ...
    uiGraphic[UI_MapEditor_Windtrap][harkIdx] = getSubPicture(
        objPic[ObjPic_Windtrap][harkIdx][0].get(), 2 * 2 * D2_TILESIZE, 0, 2 * D2_TILESIZE, 2 * D2_TILESIZE);
    static constexpr SDL_Color windtrapColor{70, 70, 70, 255};
    SDL_SetPaletteColors(SDL_GetSurfacePalette(uiGraphic[UI_MapEditor_Windtrap][harkIdx].get()),
                         &windtrapColor,
    ...
    uiGraphic[UI_MapEditor_Barracks][harkIdx] = getSubPicture(
        objPic[ObjPic_Barracks][harkIdx][0].get(), 2 * 2 * D2_TILESIZE, 0, 2 * D2_TILESIZE, 2 * D2_TILESIZE);
    ...
    uiGraphic[UI_MapEditor_Refinery][harkIdx] = getSubPicture(
        objPic[ObjPic_Refinery][harkIdx][0].get(), 2 * 3 * D2_TILESIZE, 0, 3 * D2_TILESIZE, 2 * D2_TILESIZE);
    ...
    uiGraphic[UI_MapEditor_Starport][harkIdx] = getSubPicture(
        objPic[ObjPic_Starport][harkIdx][0].get(), 2 * 3 * D2_TILESIZE, 0, 3 * D2_TILESIZE, 3 * D2_TILESIZE);
    uiGraphic[UI_MapEditor_Palace][harkIdx] = getSubPicture(
        objPic[ObjPic_Palace][harkIdx][0].get(), 2 * 3 * D2_TILESIZE, 0, 3 * D2_TILESIZE, 3 * D2_TILESIZE);
    ...
    uiGraphic[UI_MapEditor_Raider][harkIdx] =
        combinePictures(uiGraphic[UI_MapEditor_Raider][harkIdx].get(),
                        objPic[ObjPic_Star][harkIdx][1].get(),
    ...
    uiGraphic[UI_MapEditor_Tank][harkIdx] =
        combinePictures(getSubFrame(objPic[ObjPic_Tank_Base][harkIdx][0].get(), 0, 0, 8, 1).get(),
                        getSubFrame(objPic[ObjPic_Tank_Gun][harkIdx][0].get(), 0, 0, 8, 1).get(),
                        0,
                        0);
    uiGraphic[UI_MapEditor_SiegeTank][harkIdx] =
        combinePictures(getSubFrame(objPic[ObjPic_Siegetank_Base][harkIdx][0].get(), 0, 0, 8, 1).get(),
                        getSubFrame(objPic[ObjPic_Siegetank_Gun][harkIdx][0].get(), 0, 0, 8, 1).get(),
                        2,
                        -4);
    uiGraphic[UI_MapEditor_Launcher][harkIdx] =
        combinePictures(getSubFrame(objPic[ObjPic_Tank_Base][harkIdx][0].get(), 0, 0, 8, 1).get(),
                        getSubFrame(objPic[ObjPic_Launcher_Gun][harkIdx][0].get(), 0, 0, 8, 1).get(),
                        3,
                        0);
    uiGraphic[UI_MapEditor_Devastator][harkIdx] =
        combinePictures(getSubFrame(objPic[ObjPic_Devastator_Base][harkIdx][0].get(), 0, 0, 8, 1).get(),
                        getSubFrame(objPic[ObjPic_Devastator_Gun][harkIdx][0].get(), 0, 0, 8, 1).get(),
                        2,
                        -4);
    uiGraphic[UI_MapEditor_SonicTank][harkIdx] =
        combinePictures(getSubFrame(objPic[ObjPic_Tank_Base][harkIdx][0].get(), 0, 0, 8, 1).get(),
                        getSubFrame(objPic[ObjPic_Sonictank_Gun][harkIdx][0].get(), 0, 0, 8, 1).get(),
                        3,
                        1);
    uiGraphic[UI_MapEditor_Deviator][harkIdx] =
        combinePictures(getSubFrame(objPic[ObjPic_Tank_Base][harkIdx][0].get(), 0, 0, 8, 1).get(),
                        ...
                        0);
    uiGraphic[UI_MapEditor_Deviator][harkIdx] =
        combinePictures(uiGraphic[UI_MapEditor_Deviator][harkIdx].get(),
                        objPic[ObjPic_Star][harkIdx][1].get(),
    ...
    uiGraphic[UI_MapEditor_SpecialUnit][harkIdx] =
        combinePictures(getSubFrame(objPic[ObjPic_Devastator_Base][harkIdx][0].get(), 0, 0, 8, 1).get(),
                        ...
                        -4);
    uiGraphic[UI_MapEditor_SpecialUnit][harkIdx] =
        combinePictures(uiGraphic[UI_MapEditor_SpecialUnit][harkIdx].get(),
                        objPic[ObjPic_Star][harkIdx][1].get(),
    ...
    uiGraphic[UI_Background_Tile][harkIdx] = picFactory.createBackground();

    uiGraphic[UI_Background_Logo][harkIdx]                                     = picFactory.createHarkonnenLogo();
    uiGraphic[UI_Background_Logo][static_cast<int>(HOUSETYPE::HOUSE_ATREIDES)] = picFactory.createAtreidesLogo();
    uiGraphic[UI_Background_Logo][static_cast<int>(HOUSETYPE::HOUSE_ORDOS)]    = picFactory.createOrdosLogo();
    ...
    { // Scope
        auto replace_color = [&](ObjPic_enum id, HOUSETYPE house, int zoom, uint32_t oldColor, uint32_t newColor) {
            ...
            if (!SDL_SetSurfaceBlendMode(display_surface.get(), SDL_BLENDMODE_BLEND))
        ...
        for (auto zoom = 0; zoom < NUM_ZOOMLEVEL; ++zoom) {
            for (auto h = 0; h < NUM_HOUSES; ++h) {
                ...
                if (!windtrap)
                    THROW(std::runtime_error,
                          "SurfaceLoader(): Windtrap for house {} and zoom {} does not exist!",
                          h,
                          zoom);
    ...
    { // Scope
        for (auto id = UI_MapChoiceArrow_None; id <= UI_MapChoiceArrow_Left;
            ...
            for_each_housetype([&](const auto& house) {
                ...
                if (!source)
                    THROW(std::runtime_error,
                          "No source surface for generating id {} for house {}",
                          static_cast<int>(id),
...
SDL_Surface* SurfaceLoader::getZoomedObjSurface(unsigned int id, HOUSETYPE house, unsigned int z) {
    if (id >= NUM_OBJPICS) {
        THROW(std::invalid_argument,
              "SurfaceLoader::getZoomedObjSurface(): Unit Picture with ID {} is not available!",
              id);
    }
    ...
    if (surface == nullptr) {
        ...
        surface = mapSurfaceColorRange(
            objPic[id][harkonnen][z].get(), PALCOLOR_HARKONNEN, dune::globals::houseToPaletteIndex[idx]);
    }
...
SDL_Surface* SurfaceLoader::getUIGraphicSurface(unsigned int id, HOUSETYPE house) {
    if (id >= NUM_UIGRAPHICS) {
        THROW(
            std::invalid_argument, "SurfaceLoader::getUIGraphicSurface(): UI Graphic with ID {} is not available!", id);
    }
    ...
    if (target == nullptr) {
        ...
        // remap to this color
        target = mapSurfaceColorRange(
            harkonnen, PALCOLOR_HARKONNEN, dune::globals::houseToPaletteIndex[static_cast<int>(house)]);
    }
...
SDL_Surface* SurfaceLoader::getMapChoicePieceSurface(unsigned int num, HOUSETYPE house) {
    if (num >= NUM_MAPCHOICEPIECES) {
        THROW(std::invalid_argument,
              "SurfaceLoader::getMapChoicePieceSurface(): Map Piece with number {} is not available!",
              num);
    }
    ...
    if (mapChoicePieces[num][static_cast<int>(house)] == nullptr) {
        ...
        if (mapChoicePieces[num][static_cast<int>(HOUSETYPE::HOUSE_HARKONNEN)] == nullptr) {
            THROW(std::runtime_error,
                  "SurfaceLoader::getMapChoicePieceSurface(): Map Piece with number {} is not loaded!",
                  num);
        }
...
SurfaceLoader::BorderStyle SurfaceLoader::getBorderStyle(DecorationFrame type) const {
    ...
    return {bf.leftUpperCorner.get(),
            bf.rightUpperCorner.get(),
            bf.leftLowerCorner.get(),
            bf.rightLowerCorner.get(),
            bf.hborder.get(),
            bf.vborder.get()};
}
...
sdl2::surface_ptr SurfaceLoader::generateWindtrapAnimationFrames(SDL_Surface* windtrapPic) const {
    ...
    for (auto i = 0; i < NUM_WINDTRAP_ANIMATIONS; i++) {
        ...
        SDL_SetPaletteColors(SDL_GetSurfacePalette(windtrapPic), &windtrapColor, PALCOLOR_WINDTRAP_COLORCYCLE, 1);
...
sdl2::surface_ptr SurfaceLoader::generateMapChoiceArrowFrames(SDL_Surface* arrowPic, HOUSETYPE house) {
    ...
    for (int i = 0; i < 4; i++) {
        for (int k = 0; k < 4; k++) {
            ...
            SDL_SetPaletteColors(SDL_GetSurfacePalette(arrowPic), colors, 251 + k, 1);
        }
...
sdl2::surface_ptr SurfaceLoader::generateDoubledObjPic(unsigned int id, int h) const {
    ...
    if (dune::globals::settings.video.scaler == "ScaleHD") {
        ...
        if (file_manager->exists(filename)) {
            ...
            SDL_GetSurfacePalette(pOverlay.get())->colors[PALCOLOR_BLACK].g = 1;
            SDL_GetSurfacePalette(pSurface.get())->colors[PALCOLOR_BLACK].g = 1;
            SDL_BlitSurface(pOverlay.get(), nullptr, pSurface.get(), nullptr);
            SDL_GetSurfacePalette(pOverlay.get())->colors[PALCOLOR_BLACK].g = 0;
            SDL_GetSurfacePalette(pSurface.get())->colors[PALCOLOR_BLACK].g = 0;
        } else {
