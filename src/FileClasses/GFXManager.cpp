...
GFXManager::GFXManager() {
    ...
    if(pFileManager->exists("CHOAM." + _("LanguageFileExtension"))) {
        ...
        THROW(std::runtime_error,
              "GFXManager::GFXManager(): Cannot open CHOAMSHP.SHP or CHOAM." + _("LanguageFileExtension") + "!");
    }
    ...
    // Load icon file
    auto icon =
        std::make_unique<Icnfile>(pFileManager->openFile("ICON.ICN").get(), pFileManager->openFile("ICON.MAP").get());
    ...
    SDL_Log("GFXManager load time: %s", std::to_string(std::chrono::duration<double>(elapsed).count()).c_str());
    ...
    { // Scope
        ...
        SDL_SetPaletteColors(objPic[ObjPic_Harvester][harkIdx][0]->format->palette, &shadowTransparent, PALCOLOR_SHADOW, 1);
        SDL_SetSurfaceBlendMode(objPic[ObjPic_Harvester][harkIdx][0].get(), SDL_BlendMode::SDL_BLENDMODE_BLEND);
    }

    objPic[ObjPic_Harvester_Sand][harkIdx][0] = units1->getPictureArray(8,3,HARVESTERSAND_ROW(72),HARVESTERSAND_ROW(73),HARVESTERSAND_ROW(74));
    ...
    objPic[ObjPic_Ornithopter][harkIdx][0] = units->getPictureArray(8,3,ORNITHOPTER_ROW(51),ORNITHOPTER_ROW(52),ORNITHOPTER_ROW(53));
    objPic[ObjPic_OrnithopterShadow][harkIdx][0] = nullptr; // create shadow after scaling
    objPic[ObjPic_Trooper][harkIdx][0] = units->getPictureArray(4,3,INFANTRY_ROW(82),INFANTRY_ROW(83),INFANTRY_ROW(84));
    objPic[ObjPic_Troopers][harkIdx][0] = units->getPictureArray(4,4,MULTIINFANTRY_ROW(103),MULTIINFANTRY_ROW(104),MULTIINFANTRY_ROW(105),MULTIINFANTRY_ROW(106));
    objPic[ObjPic_Soldier][harkIdx][0] = units->getPictureArray(4,3,INFANTRY_ROW(73),INFANTRY_ROW(74),INFANTRY_ROW(75));
    objPic[ObjPic_Infantry][harkIdx][0] = units->getPictureArray(4,4,MULTIINFANTRY_ROW(91),MULTIINFANTRY_ROW(92),MULTIINFANTRY_ROW(93),MULTIINFANTRY_ROW(94));
    objPic[ObjPic_Saboteur][harkIdx][0] = units->getPictureArray(4,3,INFANTRY_ROW(63),INFANTRY_ROW(64),INFANTRY_ROW(65));
    objPic[ObjPic_Sandworm][harkIdx][0] = units1->getPictureArray(1,9,71|TILE_NORMAL,70|TILE_NORMAL,69|TILE_NORMAL,68|TILE_NORMAL,67|TILE_NORMAL,68|TILE_NORMAL,69|TILE_NORMAL,70|TILE_NORMAL,71|TILE_NORMAL);
    ...
    objPic[ObjPic_Hit_Gas][harkIdx][0] = mapSurfaceColorRange(objPic[ObjPic_Hit_Gas][static_cast<int>(HOUSETYPE::HOUSE_ORDOS)][0].get(), PALCOLOR_ORDOS, PALCOLOR_HARKONNEN);
    ...
    objPic[ObjPic_ExplosionSmall][harkIdx][0] = units1->getPictureArray(5,1,32|TILE_NORMAL,33|TILE_NORMAL,34|TILE_NORMAL,35|TILE_NORMAL,36|TILE_NORMAL);
    objPic[ObjPic_ExplosionMedium1][harkIdx][0] = units1->getPictureArray(5,1,47|TILE_NORMAL,48|TILE_NORMAL,49|TILE_NORMAL,50|TILE_NORMAL,51|TILE_NORMAL);
    objPic[ObjPic_ExplosionMedium2][harkIdx][0] = units1->getPictureArray(5,1,52|TILE_NORMAL,53|TILE_NORMAL,54|TILE_NORMAL,55|TILE_NORMAL,56|TILE_NORMAL);
    objPic[ObjPic_ExplosionLarge1][harkIdx][0] = units1->getPictureArray(5,1,37|TILE_NORMAL,38|TILE_NORMAL,39|TILE_NORMAL,40|TILE_NORMAL,41|TILE_NORMAL);
    objPic[ObjPic_ExplosionLarge2][harkIdx][0] = units1->getPictureArray(5,1,42|TILE_NORMAL,43|TILE_NORMAL,44|TILE_NORMAL,45|TILE_NORMAL,46|TILE_NORMAL);
    objPic[ObjPic_ExplosionSmallUnit][harkIdx][0] = units1->getPictureArray(2,1,0|TILE_NORMAL,1|TILE_NORMAL);
    objPic[ObjPic_ExplosionFlames][harkIdx][0] = units1->getPictureArray(21,1,  11|TILE_NORMAL,12|TILE_NORMAL,13|TILE_NORMAL,17|TILE_NORMAL,18|TILE_NORMAL,19|TILE_NORMAL,17|TILE_NORMAL,
    ...
    objPic[ObjPic_ExplosionSpiceBloom][harkIdx][0] = units1->getPictureArray(3,1,7|TILE_NORMAL,6|TILE_NORMAL,5|TILE_NORMAL);
    ...
    objPic[ObjPic_Smoke][harkIdx][0] = units1->getPictureArray(3,1,29|TILE_NORMAL,30|TILE_NORMAL,31|TILE_NORMAL);
    ...
    objPic[ObjPic_DestroyedStructure][harkIdx][0] = icon->getPictureRow2(14, 33, 125, 213, 214, 215, 223, 224, 225, 232, 233, 234, 240, 246, 247);
    ...
    objPic[ObjPic_Star][harkIdx][0] = LoadPNG_RW(pFileManager->openFile("Star5x5.png").get());
    objPic[ObjPic_Star][harkIdx][1] = LoadPNG_RW(pFileManager->openFile("Star7x7.png").get());
    objPic[ObjPic_Star][harkIdx][2] = LoadPNG_RW(pFileManager->openFile("Star11x11.png").get());

    SDL_Color fogTransparent = { 0, 0, 0, 96};
    SDL_SetPaletteColors(objPic[ObjPic_Terrain_HiddenFog][harkIdx][0]->format->palette, &fogTransparent, PALCOLOR_BLACK, 1);
    ...
    // load UI graphics
    uiGraphic[UI_RadarAnimation][harkIdx] = Scaler::doubleSurfaceNN(radar->getAnimationAsPictureRow(NUM_STATIC_ANIMATIONS_PER_ROW).get());
    ...
    uiGraphic[UI_CursorCapture_Zoomlevel0][harkIdx] = LoadPNG_RW(pFileManager->openFile("Capture.png").get());
    ...
    uiGraphic[UI_CursorCarryallDrop_Zoomlevel0][harkIdx] = LoadPNG_RW(pFileManager->openFile("CarryallDrop.png").get());
    ...
    uiGraphic[UI_CursorCarryallDrop_Zoomlevel2][harkIdx] =
        Scaler::defaultTripleTiledSurface(
            uiGraphic[UI_CursorCarryallDrop_Zoomlevel0][harkIdx].get(), 1, 1);
    SDL_SetColorKey(uiGraphic[UI_CursorCarryallDrop_Zoomlevel2][harkIdx].get(), SDL_TRUE, 0);

    uiGraphic[UI_ReturnIcon][harkIdx] = LoadPNG_RW(pFileManager->openFile("Return.png").get());
    SDL_SetColorKey(uiGraphic[UI_ReturnIcon][harkIdx].get(), SDL_TRUE, 0);

    uiGraphic[UI_DeployIcon][harkIdx] = LoadPNG_RW(pFileManager->openFile("Deploy.png").get());
    SDL_SetColorKey(uiGraphic[UI_DeployIcon][harkIdx].get(), SDL_TRUE, 0);

    uiGraphic[UI_DestructIcon][harkIdx] = LoadPNG_RW(pFileManager->openFile("Destruct.png").get());
    SDL_SetColorKey(uiGraphic[UI_DestructIcon][harkIdx].get(), SDL_TRUE, 0);

    uiGraphic[UI_SendToRepairIcon][harkIdx] = LoadPNG_RW(pFileManager->openFile("SendToRepair.png").get());
    SDL_SetColorKey(uiGraphic[UI_SendToRepairIcon][harkIdx].get(), SDL_TRUE, 0);

    uiGraphic[UI_CreditsDigits][harkIdx] = shapes->getPictureArray(10,1,2|TILE_NORMAL,3|TILE_NORMAL,4|TILE_NORMAL,5|TILE_NORMAL,6|TILE_NORMAL,
    ...
    uiGraphic[UI_Indicator][harkIdx] = units1->getPictureArray(3,1,8|TILE_NORMAL,9|TILE_NORMAL,10|TILE_NORMAL);
    ...
    uiGraphic[UI_SelectionBox_Zoomlevel1][harkIdx] = Scaler::defaultDoubleTiledSurface(uiGraphic[UI_SelectionBox_Zoomlevel0][harkIdx].get(), 1, 1);
    SDL_SetColorKey(uiGraphic[UI_SelectionBox_Zoomlevel1][harkIdx].get(), SDL_TRUE, 0);
    uiGraphic[UI_SelectionBox_Zoomlevel2][harkIdx] = Scaler::defaultTripleTiledSurface(uiGraphic[UI_SelectionBox_Zoomlevel0][harkIdx].get(), 1, 1);
    SDL_SetColorKey(uiGraphic[UI_SelectionBox_Zoomlevel2][harkIdx].get(), SDL_TRUE, 0);
    uiGraphic[UI_OtherPlayerSelectionBox_Zoomlevel0][harkIdx] = LoadPNG_RW(pFileManager->openFile("UI_OtherPlayerSelectionBox.png").get());
    SDL_SetColorKey(uiGraphic[UI_OtherPlayerSelectionBox_Zoomlevel0][harkIdx].get(), SDL_TRUE, 0);
    uiGraphic[UI_OtherPlayerSelectionBox_Zoomlevel1][harkIdx] = Scaler::defaultDoubleTiledSurface(uiGraphic[UI_OtherPlayerSelectionBox_Zoomlevel0][harkIdx].get(), 1, 1);
    SDL_SetColorKey(uiGraphic[UI_OtherPlayerSelectionBox_Zoomlevel1][harkIdx].get(), SDL_TRUE, 0);
    uiGraphic[UI_OtherPlayerSelectionBox_Zoomlevel2][harkIdx] = Scaler::defaultTripleTiledSurface(uiGraphic[UI_OtherPlayerSelectionBox_Zoomlevel0][harkIdx].get(), 1, 1);
    ...
    uiGraphic[UI_CustomGamePlayersArrow][harkIdx] = LoadPNG_RW(pFileManager->openFile("CustomGamePlayers_Arrow.png").get());
    SDL_SetColorKey(uiGraphic[UI_CustomGamePlayersArrow][harkIdx].get(), SDL_TRUE, 0);
    uiGraphic[UI_CustomGamePlayersArrowNeutral][harkIdx] = LoadPNG_RW(pFileManager->openFile("CustomGamePlayers_ArrowNeutral.png").get());
    ...
    uiGraphic[UI_Repair][harkIdx] = LoadPNG_RW(pFileManager->openFile("Button_Repair.png").get());
    uiGraphic[UI_Repair_Pressed][harkIdx] = LoadPNG_RW(pFileManager->openFile("Button_RepairPushed.png").get());
    uiGraphic[UI_Minus][harkIdx] = LoadPNG_RW(pFileManager->openFile("Button_Minus.png").get());
    uiGraphic[UI_Minus_Active][harkIdx] = mapSurfaceColorRange(uiGraphic[UI_Minus][harkIdx].get(), PALCOLOR_HARKONNEN, PALCOLOR_HARKONNEN-2);
    uiGraphic[UI_Minus_Pressed][harkIdx] = LoadPNG_RW(pFileManager->openFile("Button_MinusPushed.png").get());
    uiGraphic[UI_Plus][harkIdx] = LoadPNG_RW(pFileManager->openFile("Button_Plus.png").get());
    uiGraphic[UI_Plus_Active][harkIdx] = mapSurfaceColorRange(uiGraphic[UI_Plus][harkIdx].get(), PALCOLOR_HARKONNEN, PALCOLOR_HARKONNEN-2);
    ...
    uiGraphic[UI_MentatBackgroundBene][harkIdx] = Scaler::defaultDoubleSurface(LoadCPS_RW(pFileManager->openFile("MENTATM.CPS").get()).get());
    ...
    uiGraphic[UI_MapEditor_Wall][harkIdx] = getSubPicture(objPic[ObjPic_Wall][harkIdx][0].get(),2*D2_TILESIZE,0,D2_TILESIZE,D2_TILESIZE);
    uiGraphic[UI_MapEditor_GunTurret][harkIdx] = getSubPicture(objPic[ObjPic_GunTurret][harkIdx][0].get(),2*D2_TILESIZE,0,D2_TILESIZE,D2_TILESIZE);
    uiGraphic[UI_MapEditor_RocketTurret][harkIdx] = getSubPicture(objPic[ObjPic_RocketTurret][harkIdx][0].get(),2*D2_TILESIZE,0,D2_TILESIZE,D2_TILESIZE);
    uiGraphic[UI_MapEditor_ConstructionYard][harkIdx] = getSubPicture(objPic[ObjPic_ConstructionYard][harkIdx][0].get(),2*2*D2_TILESIZE,0,2*D2_TILESIZE,2*D2_TILESIZE);
    uiGraphic[UI_MapEditor_Windtrap][harkIdx] = getSubPicture(objPic[ObjPic_Windtrap][harkIdx][0].get(),2*2*D2_TILESIZE,0,2*D2_TILESIZE,2*D2_TILESIZE);
    SDL_Color windtrapColor = { 70, 70, 70, 255};
    SDL_SetPaletteColors(uiGraphic[UI_MapEditor_Windtrap][harkIdx]->format->palette, &windtrapColor, PALCOLOR_WINDTRAP_COLORCYCLE, 1);
    uiGraphic[UI_MapEditor_Radar][harkIdx] = getSubPicture(objPic[ObjPic_Radar][harkIdx][0].get(),2*2*D2_TILESIZE,0,2*D2_TILESIZE,2*D2_TILESIZE);
    uiGraphic[UI_MapEditor_Silo][harkIdx] = getSubPicture(objPic[ObjPic_Silo][harkIdx][0].get(),2*2*D2_TILESIZE,0,2*D2_TILESIZE,2*D2_TILESIZE);
    uiGraphic[UI_MapEditor_IX][harkIdx] = getSubPicture(objPic[ObjPic_IX][harkIdx][0].get(),2*2*D2_TILESIZE,0,2*D2_TILESIZE,2*D2_TILESIZE);
    uiGraphic[UI_MapEditor_Barracks][harkIdx] = getSubPicture(objPic[ObjPic_Barracks][harkIdx][0].get(),2*2*D2_TILESIZE,0,2*D2_TILESIZE,2*D2_TILESIZE);
    uiGraphic[UI_MapEditor_WOR][harkIdx] = getSubPicture(objPic[ObjPic_WOR][harkIdx][0].get(),2*2*D2_TILESIZE,0,2*D2_TILESIZE,2*D2_TILESIZE);
    uiGraphic[UI_MapEditor_LightFactory][harkIdx] = getSubPicture(objPic[ObjPic_LightFactory][harkIdx][0].get(),2*2*D2_TILESIZE,0,2*D2_TILESIZE,2*D2_TILESIZE);
    uiGraphic[UI_MapEditor_Refinery][harkIdx] = getSubPicture(objPic[ObjPic_Refinery][harkIdx][0].get(),2*3*D2_TILESIZE,0,3*D2_TILESIZE,2*D2_TILESIZE);
    uiGraphic[UI_MapEditor_HighTechFactory][harkIdx] = getSubPicture(objPic[ObjPic_HighTechFactory][harkIdx][0].get(),2*3*D2_TILESIZE,0,3*D2_TILESIZE,2*D2_TILESIZE);
    uiGraphic[UI_MapEditor_HeavyFactory][harkIdx] = getSubPicture(objPic[ObjPic_HeavyFactory][harkIdx][0].get(),2*3*D2_TILESIZE,0,3*D2_TILESIZE,2*D2_TILESIZE);
    uiGraphic[UI_MapEditor_RepairYard][harkIdx] = getSubPicture(objPic[ObjPic_RepairYard][harkIdx][0].get(),2*3*D2_TILESIZE,0,3*D2_TILESIZE,2*D2_TILESIZE);
    uiGraphic[UI_MapEditor_Starport][harkIdx] = getSubPicture(objPic[ObjPic_Starport][harkIdx][0].get(),2*3*D2_TILESIZE,0,3*D2_TILESIZE,3*D2_TILESIZE);
    uiGraphic[UI_MapEditor_Palace][harkIdx] = getSubPicture(objPic[ObjPic_Palace][harkIdx][0].get(),2*3*D2_TILESIZE,0,3*D2_TILESIZE,3*D2_TILESIZE);
    ...
    uiGraphic[UI_MapEditor_Raider][harkIdx] = combinePictures(uiGraphic[UI_MapEditor_Raider][harkIdx].get(), objPic[ObjPic_Star][harkIdx][1].get(),
    ...
    uiGraphic[UI_MapEditor_Tank][harkIdx] = combinePictures(getSubFrame(objPic[ObjPic_Tank_Base][harkIdx][0].get(),0,0,8,1).get(), getSubFrame(objPic[ObjPic_Tank_Gun][harkIdx][0].get(),0,0,8,1).get(), 0, 0);
    uiGraphic[UI_MapEditor_SiegeTank][harkIdx] = combinePictures(getSubFrame(objPic[ObjPic_Siegetank_Base][harkIdx][0].get(),0,0,8,1).get(), getSubFrame(objPic[ObjPic_Siegetank_Gun][harkIdx][0].get(),0,0,8,1).get(), 2, -4);
    uiGraphic[UI_MapEditor_Launcher][harkIdx] = combinePictures(getSubFrame(objPic[ObjPic_Tank_Base][harkIdx][0].get(),0,0,8,1).get(), getSubFrame(objPic[ObjPic_Launcher_Gun][harkIdx][0].get(),0,0,8,1).get(), 3, 0);
    uiGraphic[UI_MapEditor_Devastator][harkIdx] = combinePictures(getSubFrame(objPic[ObjPic_Devastator_Base][harkIdx][0].get(),0,0,8,1).get(), getSubFrame(objPic[ObjPic_Devastator_Gun][harkIdx][0].get(),0,0,8,1).get(), 2, -4);
    uiGraphic[UI_MapEditor_SonicTank][harkIdx] = combinePictures(getSubFrame(objPic[ObjPic_Tank_Base][harkIdx][0].get(),0,0,8,1).get(), getSubFrame(objPic[ObjPic_Sonictank_Gun][harkIdx][0].get(),0,0,8,1).get(), 3, 1);
    uiGraphic[UI_MapEditor_Deviator][harkIdx] = combinePictures(getSubFrame(objPic[ObjPic_Tank_Base][harkIdx][0].get(),0,0,8,1).get(), getSubFrame(objPic[ObjPic_Launcher_Gun][harkIdx][0].get(),0,0,8,1).get(), 3, 0);
    uiGraphic[UI_MapEditor_Deviator][harkIdx] = combinePictures(uiGraphic[UI_MapEditor_Deviator][harkIdx].get(), objPic[ObjPic_Star][harkIdx][1].get(),
    ...
    uiGraphic[UI_MapEditor_SpecialUnit][harkIdx] = combinePictures(getSubFrame(objPic[ObjPic_Devastator_Base][harkIdx][0].get(),0,0,8,1).get(), getSubFrame(objPic[ObjPic_Devastator_Gun][harkIdx][0].get(),0,0,8,1).get(), 2, -4);
    uiGraphic[UI_MapEditor_SpecialUnit][harkIdx] = combinePictures(uiGraphic[UI_MapEditor_SpecialUnit][harkIdx].get(), objPic[ObjPic_Star][harkIdx][1].get(),
    ...
    uiGraphic[UI_MapEditor_Ornithopter][harkIdx] = getSubFrame(objPic[ObjPic_Ornithopter][harkIdx][0].get(),0,0,8,3);

    uiGraphic[UI_MapEditor_Pen1x1][harkIdx] = LoadPNG_RW(pFileManager->openFile("MapEditorPen1x1.png").get());
    SDL_SetColorKey(uiGraphic[UI_MapEditor_Pen1x1][harkIdx].get(), SDL_TRUE, 0);
    uiGraphic[UI_MapEditor_Pen3x3][harkIdx] = LoadPNG_RW(pFileManager->openFile("MapEditorPen3x3.png").get());
    SDL_SetColorKey(uiGraphic[UI_MapEditor_Pen3x3][harkIdx].get(), SDL_TRUE, 0);
    uiGraphic[UI_MapEditor_Pen5x5][harkIdx] = LoadPNG_RW(pFileManager->openFile("MapEditorPen5x5.png").get());
